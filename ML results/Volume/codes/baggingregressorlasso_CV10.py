...
current_directory = '/home/mmaximo/ML/Thermophysical/Volume'    #if used on the cluster

## Data output
txt_header = 'Temperature (K)\tPressure (MPa)\tExperimental(m3/kg)\tNIST(m3/kg)\tModel(m3/kg)'
