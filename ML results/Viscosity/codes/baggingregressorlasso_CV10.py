...
#current_directory = 'gdrive/MyDrive/Thermophysical/Viscosity'

current_directory = '/home/mmaximo/ML/Thermophysical/Viscosity'    #if used on the cluster

## Data output
txt_header = 'Temperature (K)\tPressure (MPa)\tExperimental(uPas)\tNIST(uPas)\tModel(uPas)'
