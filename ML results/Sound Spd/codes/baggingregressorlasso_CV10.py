...
#current_directory = 'gdrive/MyDrive/Thermophysical/Sound Spd'

current_directory = '/home/mmaximo/ML/Thermophysical/Sound Spd'    #if used on the cluster

## Data output
txt_header = 'Temperature (K)\tPressure (MPa)\tExperimental(m/s)\tNIST(m/s)\tModel(m/s)'
