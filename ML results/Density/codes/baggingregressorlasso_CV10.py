...
#current_directory = 'gdrive/MyDrive/Thermophysical/Density'

current_directory = '/home/mmaximo/ML/Thermophysical/Density'    #if used on the cluster

## Data output
txt_header = 'Temperature (K)\tPressure (MPa)\tExperimental(kg/m3)\tNIST(kg/m3)\tModel(kg/m3)'
# ********************** DATA ACQUISITION **********************
                     #*****  NIST  *****
