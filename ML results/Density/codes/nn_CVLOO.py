...
# ********************** NeuralNetwork **********************
NeuralNetwork_directory = os.path.join(property_directory, "NeuralNetworkCVLOO")
...
if len(X_supercritical_Exp) > 0:
    ...
    save_to_file_and_print(f"\nBest Hyperparameters for supercritical state for Neural Network: {model_supercritical.get_params()}.\n", NeuralNetwork_file)
