...
Original file is located at
    https://colab.research.google.com/drive/1_1V9E5FguwEB-oyv4HKwzCGdB6wUcVdf
"""
...
if len(X_liquid_Exp) > 0:
   ...
   save_to_file_and_print("There are no Liquid data", LazyPredict_file)
...
if len(X_vapor_Exp) > 0:
   ...
   save_to_file_and_print("there are no Vapor data", LazyPredict_file)
...
if len(X_supercritical_Exp) > 0:
   ...
   save_to_file_and_print("There are no supercritical data", LazyPredict_file)