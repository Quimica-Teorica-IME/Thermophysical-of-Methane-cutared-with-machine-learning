...
# ***** DECISION TREE *****
DT_file = check_and_get_filename(current_directory, "DecisionTree_Physical-State-Determination_NuSVR", "log")
...
# ********************** NuSVR **********************
NuSVR_directory = os.path.join(property_directory, "NuSVR")
os.makedirs(NuSVR_directory, exist_ok=True)
NuSVR_file = check_and_get_filename(NuSVR_directory, "NuSVR", "log")
