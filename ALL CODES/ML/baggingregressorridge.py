...
BaggingRegressorRidge_directory = os.path.join(property_directory, "BaggingRegressorRidge")
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", BaggingRegressorRidge_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", BaggingRegressorRidge_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", BaggingRegressorRidge_file)
