# -*- coding: utf-8 -*-
"""Adaboost-Ridge.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1i-nXIOKqmyL-AePz80U-giw3cv-FyXZA
"""
...
# ********************** AdaboostRidge **********************
AdaboostRidge_directory = os.path.join(property_directory, "AdaboostRidge")
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", AdaboostRidge_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", AdaboostRidge_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", AdaboostRidge_file)
