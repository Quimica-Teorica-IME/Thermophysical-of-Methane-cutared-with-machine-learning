# -*- coding: utf-8 -*-
"""Adaboost-Lasso.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1QWGFFcqxi5HQGlqbB5Q6tgfFXtbnerDR
"""
...
# ********************** AdaboostLasso **********************
AdaboostLasso_directory = os.path.join(property_directory, "AdaboostLasso")
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", AdaboostLasso_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", AdaboostLasso_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", AdaboostLasso_file)
...
if len(X_liquid_Exp) > 0:
    ...
    grid_search_liquid = GridSearchCV(
        AdaBoostRegressor(base_estimator=base_estimator),
        param_grid={
