...
Original file is located at
    https://colab.research.google.com/drive/1Aj4ZIAs35HwEhZFqX8IZ-A50aUbf7INl
"""
...
def plot_comparison(phase_name, y_exp, y_nist, y_model, save_path=None, name=None):
    ...
    plt.scatter(y_exp, y_model, color='red', label='NeuralNetwork_WithoutGridsearch', marker = '+', s=40, linewidth=1)

    plt.xlabel('Experimental')
    plt.ylabel('NeuralNetwork_WithoutGridsearch & NIST')
    plt.title(phase_name)
    plt.legend()
...
# ***** DECISION TREE *****
DT_file = check_and_get_filename(current_directory, "DecisionTree_Physical-State-Determination_NeuralNetwork_WithoutGridsearch", "log")
...
# ********************** NeuralNetwork_WithoutGridsearch **********************
NeuralNetwork_WithoutGridsearch_directory = os.path.join(property_directory, "NeuralNetwork_WithoutGridsearch")
os.makedirs(NeuralNetwork_WithoutGridsearch_directory, exist_ok=True)
NeuralNetwork_WithoutGridsearch_file = check_and_get_filename(NeuralNetwork_WithoutGridsearch_directory, "NeuralNetwork_WithoutGridsearch", "log")
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", NeuralNetwork_WithoutGridsearch_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", NeuralNetwork_WithoutGridsearch_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", NeuralNetwork_WithoutGridsearch_file)
...
#              NEURAL NETWORK
#===========================================
save_to_file_and_print("\n\n>>> LIQUID PHASE <<<\n", NeuralNetwork_WithoutGridsearch_file)
...
if len(X_liquid_Exp) > 0:
    ...
    # Creating the MLPRegressor model with the hyperparameters
    model_liquid = MLPRegressor(**params_liquid)

    model_liquid.fit(X_liquid_train, y_liquid_train)

    joblib.dump(model_liquid, os.path.join(NeuralNetwork_WithoutGridsearch_directory, 'Model_NeuralNetwork_WithoutGridsearch_liquid.pkl'))

    #model_liquid_path = os.path.join(NeuralNetwork_WithoutGridsearch_directory, 'Model_NeuralNetwork_WithoutGridsearch_liquid.pkl')
    ...
    # >>> Train <<<
    save_to_file_and_print("\n > Train data <", NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics('liquid', y_liquid_train, y_pred_train_liquid, file=NeuralNetwork_WithoutGridsearch_file)

    # >>> Test <<<
    save_to_file_and_print("\n > Test data <", NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics('liquid', y_liquid_test,  y_pred_test_liquid, file=NeuralNetwork_WithoutGridsearch_file)

    plot_overfitting_evaluation(y_liquid_test, y_pred_test_liquid, save_path=NeuralNetwork_WithoutGridsearch_directory, name="NeuralNetwork_WithoutGridsearch-overfitting_evaluation-liquid", phase_name="liquid")
    ...
    #y_pred_test_liquid_array = np.array(model_liquid.predict(X_liquid_Exp))

    #liquid
    save_to_file_and_print(">>> Comparison: Liquid <<<\n", NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics("liquid - Exp x NIST", y_liquid_Exp_array, y_liquid_NIST_Expbased_array, file=NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics("liquid - Exp x Model", y_liquid_Exp_array, y_pred_liquid_cv_array, file=NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics("liquid - NIST x Model", y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array, file=NeuralNetwork_WithoutGridsearch_file)

    plot_comparison("liquid", y_liquid_Exp_array, y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array, save_path=NeuralNetwork_WithoutGridsearch_directory, name="ModelxNISTxExp-liquid")
    plot_overfitting_evaluation(y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array, save_path=NeuralNetwork_WithoutGridsearch_directory, name="ModelxNIST-liquid", phase_name='Liquid')


    # Save liquid data
    liquid_data = np.column_stack((X_liquid_Exp, y_liquid_Exp_array, y_liquid_NIST_Expbased_array, y_pred_liquid_cv_array))
    np.savetxt(os.path.join(NeuralNetwork_WithoutGridsearch_directory, 'liquid_data.txt'), liquid_data, delimiter='\t', header=txt_header)
...
if len(X_vapor_Exp) > 0:
    ...
    # Creating the MLPRegressor model with the hyperparameters
    model_vapor = MLPRegressor(**params_vapor)

    model_vapor.fit(X_vapor_train, y_vapor_train)

    joblib.dump(model_vapor, os.path.join(NeuralNetwork_WithoutGridsearch_directory, 'Model_NeuralNetwork_WithoutGridsearch_vapor.pkl'))

    #model_vapor_path = os.path.join(NeuralNetwork_WithoutGridsearch_directory, 'Model_NeuralNetwork_WithoutGridsearch_vapor.pkl')
    ...
    # >>> Train <<<
    save_to_file_and_print("\n > Train data <", NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics('vapor', y_vapor_train, y_pred_train_vapor, file=NeuralNetwork_WithoutGridsearch_file)

    # >>> Test <<<
    save_to_file_and_print("\n > Test data <", NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics('vapor', y_vapor_test,  y_pred_test_vapor, file=NeuralNetwork_WithoutGridsearch_file)

    plot_overfitting_evaluation(y_vapor_test, y_pred_test_vapor, save_path=NeuralNetwork_WithoutGridsearch_directory, name="NeuralNetwork_WithoutGridsearch-overfitting_evaluation-vapor", phase_name="vapor")
    ...
    print(f"\n\n{y_pred_vapor_cv_array}\n{len(y_pred_vapor_cv_array)}\n")
    print(f"\n\n{y_vapor_NIST_Expbased_array}\n{len(y_vapor_NIST_Expbased_array)}\n")
    print(f"\n\n{y_vapor_Exp_array}\n{len(y_vapor_Exp_array)}\n")

    #vapor
    save_to_file_and_print(">>> Comparison: Vapor <<<\n", NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics("vapor - Exp x NIST", y_vapor_Exp_array, y_vapor_NIST_Expbased_array, file=NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics("vapor - Exp x Model", y_vapor_Exp_array, y_pred_vapor_cv_array, file=NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics("vapor - NIST x Model", y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array, file=NeuralNetwork_WithoutGridsearch_file)

    plot_comparison("vapor",  y_vapor_Exp_array, y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array, save_path=NeuralNetwork_WithoutGridsearch_directory, name="ModelxNISTxExp-vapor")
    plot_overfitting_evaluation(y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array, save_path=NeuralNetwork_WithoutGridsearch_directory, name="ModelxNIST-vapor", phase_name='Vapor')


    # Save vapor data
    vapor_data = np.column_stack((X_vapor_Exp, y_vapor_Exp_array, y_vapor_NIST_Expbased_array, y_pred_vapor_cv_array))
    np.savetxt(os.path.join(NeuralNetwork_WithoutGridsearch_directory, 'vapor_data.txt'), vapor_data, delimiter='\t', header=txt_header)
...
if len(X_supercritical_Exp) > 0:
    ...
    # Creating the MLPRegressor model with the hyperparameters
    model_supercritical = MLPRegressor(**params_supercritical)
    model_supercritical.fit(X_supercritical_train, y_supercritical_train)

    joblib.dump(model_supercritical, os.path.join(NeuralNetwork_WithoutGridsearch_directory, 'Model_NeuralNetwork_WithoutGridsearch_supercritical.pkl'))

    #model_supercritical_path = os.path.join(NeuralNetwork_WithoutGridsearch_directory, 'Model_NeuralNetwork_WithoutGridsearch_supercritical.pkl')
    ...
    # >>> Train <<<
    save_to_file_and_print("\n > Train data <", NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics('supercritical', y_supercritical_train, y_pred_train_supercritical, file=NeuralNetwork_WithoutGridsearch_file)

    # >>> Test <<<
    save_to_file_and_print("\n > Test data <", NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics('supercritical', y_supercritical_test,  y_pred_test_supercritical, file=NeuralNetwork_WithoutGridsearch_file)

    plot_overfitting_evaluation(y_supercritical_test, y_pred_test_supercritical, save_path=NeuralNetwork_WithoutGridsearch_directory, name="NeuralNetwork_WithoutGridsearch-overfitting_evaluation-supercritical", phase_name="supercritical")
    ...
    #y_pred_test_supercritical_array = np.array(model_supercritical.predict(X_supercritical_Exp))

    #supercritical
    save_to_file_and_print(">>> Comparison: Supercritical <<<\n", NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics("supercritical - Exp x NIST", y_supercritical_Exp_array, y_supercritical_NIST_Expbased_array, file=NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics("supercritical - Exp x Model", y_supercritical_Exp_array, y_pred_supercritical_cv_array, file=NeuralNetwork_WithoutGridsearch_file)
    calculate_metrics("supercritical - NIST x Model", y_supercritical_NIST_Expbased_array, y_pred_supercritical_cv_array, file=NeuralNetwork_WithoutGridsearch_file)

    plot_comparison("supercritical", y_supercritical_Exp_array, y_supercritical_NIST_Expbased_array, y_pred_supercritical_cv_array, save_path=NeuralNetwork_WithoutGridsearch_directory, name="ModelxNISTxExp-supercritical")
    plot_overfitting_evaluation(y_supercritical_NIST_Expbased_array, y_pred_supercritical_cv_array, save_path=NeuralNetwork_WithoutGridsearch_directory, name="ModelxNIST-Supercritical", phase_name='Supercritical')
    ...
    np.savetxt(os.path.join(NeuralNetwork_WithoutGridsearch_directory, 'supercritical_data.txt'), supercritical_data, delimiter='\t', header=txt_header)


else:
    save_to_file_and_print(f"!!!!! No data points available for the supercritical state for the {property_name} !!!!!", NeuralNetwork_WithoutGridsearch_file)
