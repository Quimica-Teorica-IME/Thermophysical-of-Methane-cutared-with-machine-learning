# -*- coding: utf-8 -*-
"""ExtraTressRegressor.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1nWBWEuYywgoi1ONV68DXJwkds_yo1B-H
"""
...
# ********************** ExtraTreesRegressor **********************
ExtraTreesRegressor_directory = os.path.join(property_directory, "ExtraTreesRegressor")
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", ExtraTreesRegressor_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", ExtraTreesRegressor_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", ExtraTreesRegressor_file)
