...
Original file is located at
    https://colab.research.google.com/drive/1CRNuFA6HM9xnAjm4YMid9OkeXsR8J2xK
"""
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", KNeighbors_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", KNeighbors_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", KNeighbors_file)
