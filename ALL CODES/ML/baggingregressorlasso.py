# -*- coding: utf-8 -*-
"""BaggingRegressorLasso.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ix81T0El1bbkHXdQxM8m8EBaLN5Kaiuq
"""
...
BaggingRegressorLasso_directory = os.path.join(property_directory, "BaggingRegressorLasso")
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", BaggingRegressorLasso_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", BaggingRegressorLasso_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", BaggingRegressorLasso_file)
