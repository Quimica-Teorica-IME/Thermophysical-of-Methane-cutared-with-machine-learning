...
Original file is located at
    https://colab.research.google.com/drive/1qmnOqgtYdqlEN1UdIL18lkvLJbUtaJIV
"""
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", RandomForest_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", RandomForest_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", RandomForest_file)
...
if len(X_supercritical_Exp) > 0:
    ...
    save_to_file_and_print(f"!!!!! No data points available for the supercritical state for the {property_name} !!!!!")
