...
Original file is located at
    https://colab.research.google.com/drive/1UjnTnVdfP5TKFe4W9Irk_b3tV-wE81wB
"""
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", LGBM_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", LGBM_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", LGBM_file)
...
if len(X_supercritical_Exp) > 0:
    ...
    model_supercritical = LGBMRegressor(
        n_estimators=50,
        learning_rate=0.1,
        max_depth=3,
        num_leaves=31,
    ...
    # Grid Search for Hyperparameter Tuning for supercritical state with LGBMRegressor
