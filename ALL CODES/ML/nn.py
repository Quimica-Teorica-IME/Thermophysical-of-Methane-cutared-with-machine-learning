...
# ********************** NeuralNetwork **********************
NeuralNetwork_directory = os.path.join(property_directory, "NeuralNetwork")
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", NeuralNetwork_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", NeuralNetwork_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", NeuralNetwork_file)
