# -*- coding: utf-8 -*-
"""NuSVRRegressor.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1OGHPAmamTGYLEN8chmbR0Ttvk_mKCAPB
"""
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", NuSVR_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", NuSVR_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", NuSVR_file)
