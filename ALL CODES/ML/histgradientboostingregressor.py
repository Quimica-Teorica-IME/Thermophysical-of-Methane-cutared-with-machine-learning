...
Original file is located at
    https://colab.research.google.com/drive/13Qwu5yG1HOhtUQosT2qKjar1y7IRKl5-
"""
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", HistGradientBoosting_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", HistGradientBoosting_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", HistGradientBoosting_file)
