...
Original file is located at
    https://colab.research.google.com/drive/1xAORWQCiSPvtxzbXiX-lC0Wz00cPjnsX
"""
...
# ********************** DecisionTree **********************
DecisionTree_directory = os.path.join(property_directory, "DecisionTree")
...
save_to_file_and_print(f"\nNumber of data points in Liquid state: {len(X_liquid_Exp)}", DecisionTree_file)
save_to_file_and_print(f"Number of data points in Vapor state: {len(X_vapor_Exp)}", DecisionTree_file)
save_to_file_and_print(f"Number of data points in Supercritical state: {len(X_supercritical_Exp)}", DecisionTree_file)
